...
public class DemoUncheckedException {
  ...
  public static void main(String[] args) {
    //!Example of "Unchecked" exception-> Java won't force you to catch during compile time
    int year=Integer.valueOf("abc"); //"abc" is a String, compiler treat "abc" is a String->no compile error
 ...
 // ! Bug is avoidable by developer
    ...
    // Case 2:
    //!if string s ==null-> null pointer exception
    String s = "hello";
    if (s != null) {
